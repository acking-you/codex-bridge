//! Binary entrypoint for My QQ Bot.

use std::path::PathBuf;

use anyhow::Result;
use clap::Parser;
use qqbot_cli::cli::{Cli, Commands};
use qqbot_core::{api, config::RuntimeConfig, launcher, napcat, service::ServiceState};
use serde_json::{json, Value};
use tokio::sync::mpsc;
use tracing_subscriber::EnvFilter;

const DEFAULT_LOG_FILTER: &str = "warn,qqbot_cli=info,qqbot_core=info";
